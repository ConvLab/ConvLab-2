...
For participants interested in the performance of the baseline model, please check the model performance of [BERTNLU + RuleDST + RulePolicy + TemplateNLG](https://github.com/thu-coai/ConvLab-2/blob/master/tests/test_BERTNLU-RuleDST-RulePolicy-TemplateNLG.py) in ConvLab-2.
