...
For participants interested in the baseline model performance, please check [BERTNLU + RuleDST + RulePolicy + TemplateNLG](https://github.com/thu-coai/ConvLab-2/blob/master/tests/test_BERTNLU-RuleDST-RulePolicy-TemplateNLG.py) in ConvLab-2.
